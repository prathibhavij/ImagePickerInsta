package com.application.android.imagepicker.video;
...
import com.application.android.imagepicker.cameraview.video.AutoFitTextureView;
...
public class CaptureVideoFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mTextureView = view.findViewById(R.id.mCameraVideoView);
    ...
    private void releaseCamera(){
        if (mCameraDevice != null){       // release the camera for other applications
            mCameraDevice = null;
        }
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        mNextVideoAbsolutePath = getOutputMediaFile(MEDIA_TYPE_VIDEO).getAbsolutePath();
    ...
    private void stopRecordingVideo() {
        ...
        activity.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(mNextVideoAbsolutePath))));
